...
export default function AnimatedGradientText({
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 block h-full w-full animate-gradient bg-linear-to-r from-(--brand-2)/50 via-(--brand-1)/50 to-(--brand-2)/50 bg-[length:var(--bg-size)_100%] p-[1px] ![mask-composite:subtract] [border-radius:inherit] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)]`}
      />
